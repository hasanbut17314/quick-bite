...
//       // Simulate a successful login with complete user data
//       const token = "simulated_token";
//       const user = { 
//         _id: "simulated_user_id_123", // Added _id to match dashboard requirements
//         name: "John Doe", 
...
const Login = ({ isDarkMode, toggleDarkMode }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token && user) {
        login(token, user, formData.remember); // You may handle remember me in your auth context
        navigate("/dashboard");
      } else {
